...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    description:
      "Traditional watercolor painting depicting the journey of blood from donor to recipient",
    artist: "Michael Chen",
    artistAvatar: "/placeholder.svg?height=40&width=40",
  ...
  },
  {
    ...
    description:
      "Photography series capturing the emotions and stories of blood donors",
  ...
  },
  {
    ...
    description:
      "Intricate mandala design incorporating blood drop motifs and healing symbols",
    artist: "Aisha Okafor",
    artistAvatar: "/placeholder.svg?height=40&width=40",
    category: "Digital Art",
...
const contests: Contest[] = [
  {
    ...
    description:
      "Create artwork that celebrates the everyday heroes who donate blood and save lives",
  ...
  },
  {
    ...
    description:
      "Envision the future of healthcare and blood donation through artistic expression",
    ...
    <div className="space-y-8">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Explore creative expressions of blood donation and healthcare through
          community art. Share your artwork, participate in contests, and
        ...
        <Tabs defaultValue="gallery" className="w-full">
              ...
              <section className="space-y-4">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    This week&apos;s highlighted creation
                  </p>
                </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {Math.round(
                            (contest.submissions / contest.maxSubmissions) * 100
                          )}
                          %
                        </span>
                      </div>
          ...
          <TabsContent value="artists" className="space-y-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Meet the talented artists in our community
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <TabsContent value="create" className="space-y-6">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Share your blood donation themed artwork with the community
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create artwork directly in your browser
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Please review these guidelines before submitting your artwork
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2 text-sm">
                        ...
                        <span>
                          Must relate to blood donation or healthcare themes
                        </span>
                      </li>
                      <li className="flex items-start gap-2 text-sm">
                        <Heart className="h-4 w-4 text-red-600 mt-0.5 flex-shrink-0" />
            ...
            <div className="space-y-6">
              <DialogHeader>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <Badge
                      className={getCategoryColor(selectedArtwork.category)}
                    >
