...
export function AiCornerPage() {
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      ...
      type: "bot",
      content:
        "Hello! I'm your AI assistant for blood donation queries. How can I help you today?",
  ...
  const generateAIResponse = (userMessage: string): string => {
    ...
    if (message.includes("eligib") || message.includes("can i donate")) {
      ...
      message.includes("how to donate")
    ) {
  ...
  const handleEligibilityCheck = () => {
    ...
    if (result === "eligible") {
      ...
      setEligibilityResult(
        `Based on your responses, you may not be eligible to donate at this time. Reasons: ${reasons.join(
          ", "
        )}. Please consult with our medical team for specific guidance.`
      );
    }
  };
    ...
    <div className="space-y-8">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Explore cutting-edge AI technology in healthcare, interact with
          intelligent tools, and discover how artificial intelligence is
          revolutionizing blood donation and medical services.
        </p>
      </section>
          ...
          <TabsContent value="chatbot" className="space-y-6">
            <Card className="max-w-4xl mx-auto">
              <CardHeader>
                ...
                <CardDescription>
                  Ask questions about blood donation, eligibility, processes,
                  and more. Our AI assistant is here to help!
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setNewMessage("Am I eligible to donate blood?")
                    }
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setNewMessage("What is the donation process?")
                    }
                    className="bg-transparent"
                  >
                    Donation Process
          ...
          <TabsContent value="tools" className="space-y-6">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Advanced AI assessment to determine your blood donation
                    eligibility
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  {eligibilityResult && (
                    <div
                      className={`p-4 rounded-lg border ${
                        ...
                        !eligibilityResult.includes("not eligible")
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    AI-powered system for emergency blood request matching
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Set up intelligent reminders based on your donation history
                  and preferences
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="8weeks">
                            Every 8 weeks (Standard)
                          </SelectItem>
                          <SelectItem value="10weeks">
                            Every 10 weeks
                          </SelectItem>
                          <SelectItem value="12weeks">
                            Every 12 weeks
                          </SelectItem>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2 text-sm">
                        ...
                        <span>
                          Personalized timing based on your donation history
                        </span>
                      </li>
                      <li className="flex items-start gap-2 text-sm">
                        <Sparkles className="h-4 w-4 text-orange-600 mt-0.5 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2 text-sm">
                        <Sparkles className="h-4 w-4 text-orange-600 mt-0.5 flex-shrink-0" />
                        <span>
                          Emergency request alerts for your blood type
                        </span>
                      </li>
                      <li className="flex items-start gap-2 text-sm">
                        <Sparkles className="h-4 w-4 text-orange-600 mt-0.5 flex-shrink-0" />
