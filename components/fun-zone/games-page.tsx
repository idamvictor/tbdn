...
const games: Game[] = [
  {
    ...
    description: "Match blood types with compatible donors and recipients in this fast-paced puzzle game",
    category: "Matching",
    difficulty: "Medium",
    duration: "5-10 min",
    players: 1247,
    ...
    features: ["Real-time matching", "Progressive difficulty", "Educational tips", "Score multipliers"],
    educationalFacts: [
  ...
  },
  {
    ...
    description: "Test your knowledge about the blood donation process with interactive questions",
    category: "Quiz",
    difficulty: "Easy",
    duration: "3-5 min",
    players: 2156,
    rating: 4.6,
    image: "/placeholder.svg?height=200&width=300",
    features: ["Multiple choice questions", "Instant feedback", "Progress tracking", "Fact explanations"],
    educationalFacts: [
  ...
  },
  {
    ...
    description: "Challenge yourself with fascinating health and blood-related trivia questions",
    category: "Quiz",
    difficulty: "Hard",
    duration: "10-15 min",
    players: 892,
    rating: 4.9,
    image: "/placeholder.svg?height=200&width=300",
    features: ["Timed questions", "Bonus rounds", "Difficulty scaling", "Expert mode"],
    educationalFacts: [
  ...
  },
  {
    ...
    description: "Manage your own virtual blood drive and learn about logistics and coordination",
    category: "Simulation",
    difficulty: "Medium",
    duration: "15-20 min",
    players: 634,
    rating: 4.7,
    image: "/placeholder.svg?height=200&width=300",
    features: ["Resource management", "Event planning", "Donor coordination", "Impact tracking"],
    educationalFacts: [
  ...
  },
  {
    ...
    description: "Separate blood donation myths from facts in this educational challenge",
    category: "Challenge",
    difficulty: "Easy",
    duration: "5-8 min",
    players: 1543,
    rating: 4.5,
    image: "/placeholder.svg?height=200&width=300",
    features: ["True/False format", "Myth explanations", "Fact verification", "Social sharing"],
    educationalFacts: [
    ...
    <div className="space-y-8">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Learn about blood donation through fun, interactive games. Earn achievements, compete on leaderboards, and
          ...
          <TabsContent value="games" className="space-y-6">
            ...
            <Card className="bg-gradient-to-r from-blue-50 to-blue-100">
              <CardHeader>
                ...
                <CardDescription>Learn interesting facts while you play!</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              {achievements.map((achievement) => (
                <Card
                  ...
                  className={`overflow-hidden transition-all ${
                    achievement.unlocked ? "bg-gradient-to-br from-yellow-50 to-yellow-100" : "opacity-75"
                  }`}
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                  ...
                  {leaderboard.map((entry) => (
                    <div
                      ...
                      className={`flex items-center gap-4 p-4 rounded-lg border ${
                        entry.rank <= 3 ? "bg-gradient-to-r from-yellow-50 to-yellow-100" : "bg-muted/50"
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <div
                        ...
                        <Avatar>
                          ...
                          <AvatarFallback>{entry.username.split("").slice(0, 2).join("").toUpperCase()}</AvatarFallback>
                        </Avatar>
                        <div>
