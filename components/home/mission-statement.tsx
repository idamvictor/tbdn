      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        >
          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            ...
            >
              <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-red-600 via-pink-600 to-red-700 bg-clip-text text-transparent leading-tight">
                Our Mission
              </h2>
              <motion.div
          ...
          <motion.div className="space-y-12" variants={itemVariants}>
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h3 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                Our Core Values
              </h3>
              <motion.div
            ...
            >
              {coreValues.map((value) => {
                ...
                return (
                  ...
                  >
                    <div className="relative p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/50 overflow-hidden h-full">
                      ...
                      <div className="relative flex flex-col items-center text-center space-y-6">
                        {/* Icon Container */}
                        <motion.div
                          className={`relative p-4 ${value.bgColor} ${value.hoverBg} rounded-2xl transition-all duration-300 shadow-md group-hover:shadow-lg`}
                          variants={iconVariants}
                          whileHover="hover"
                        >
                          <Icon className={`h-10 w-10 ${value.iconColor}`} />
          ...
          <motion.div className="pt-12" variants={itemVariants}>
            <motion.button
              className="inline-flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 font-semibold text-lg"
